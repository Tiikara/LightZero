...
from .capsnet_ext_modules import CapsInitialModuleWithoutSquash
...
class RepresentationNetworkUniZeroCapsnetSquashless(nn.Module):
    ...
    def __init__(
        ...
        self.caps = nn.Sequential(
            CapsInitialModuleWithoutSquash(
