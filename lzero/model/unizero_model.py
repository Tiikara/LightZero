...
from .exts.representation_network_unizero_mobilenetv4 import RepresentationNetworkUniZeroMobilenetV4
    ...
    def __init__(
        ...
        if world_model_cfg.obs_type == 'vector':
            ...
            if use_optimized_representation:
                self.representation_network = RepresentationNetworkUniZeroMobilenetV4(
                    observation_shape,
                    num_res_blocks,
                    activation=self.activation,
                    norm_type=norm_type,
            ...
            if world_model_cfg.latent_recon_loss_weight != 0. or world_model_cfg.perceptual_loss_weight != 0.:
                ...
                if world_model_cfg.perceptual_loss_weight != 0.:
                    with_lpips = True
                else:
                    with_lpips = False
            else:
