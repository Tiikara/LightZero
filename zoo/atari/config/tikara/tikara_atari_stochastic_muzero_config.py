...
atari_stochastic_muzero_config = dict(
    ...
    env=dict(
        ...
        save_replay=True,
        replay_path='/mnt/d/source/LightZero/data_stochastic_mz/replay',
    ),
    policy=dict(
        model=dict(
        ...
        model_path="/mnt/d/source/LightZero/data_stochastic_mz/2024_07_22_13_30/ckpt/iteration_56000.pth.tar",
        cuda=True,
        gumbel_algo=False,
        mcts_ctree=True,
