    ...
    policy=dict(
        model=dict(
            ...
            world_model_cfg=dict(
                ...
                embed_dim=768,
                obs_type='image',
                transformer_norm_type='RMS', # LN - LayerNorm (default: UniZero), RMS - RMSNorm
                transformer_feed_forward_type='swiglu', # base - L->GELU-L (default: UniZero), swiglu - L->SwiGLU-L
