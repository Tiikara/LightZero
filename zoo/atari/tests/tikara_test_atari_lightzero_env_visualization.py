...
from zoo.atari.config.tikara.tikara_atari_unizero_config import create_config, main_config
...
class TestAtariEnvLightZeroVisualization:
    ...
    def test_lightzero_env(self):
        ...
        model_path = "/mnt/d/source/LightZero/data_unizero/Pong_stack1_unizero_upcNone-rr0.25_H10_bs64_seed0/ckpt/ckpt_best.pth.tar"
