...
from zoo.retro.envs.retro_wrappers import wrap_lightzero


@ENV_REGISTRY.register('retro_lightzero')
class RetroEnvLightZero(BaseEnv):
    """
    Overview:
    ...
    def reset(self) -> dict:
        ...
        # Seed is not supported by retro
